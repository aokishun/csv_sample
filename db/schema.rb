...
ActiveRecord::Schema.define(version: 2019_02_15_082214) do
  ...
  create_table "wp_ariadminer_connections", primary_key: "connection_id", id: :integer, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "wp_cocoon_accesses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci", force: :cascade do |t|
    t.bigint "post_id"
    t.string "post_type", limit: 10, default: "post"
    t.string "date", limit: 20
    t.bigint "count", default: 0
    t.string "last_ip", limit: 40
    t.index ["post_id", "post_type", "date"], name: "index_pid_ptype_date"
  end

  create_table "wp_cocoon_affiliate_tags", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci", force: :cascade do |t|
    t.datetime "date", null: false
    t.datetime "modified", null: false
    t.string "title", limit: 126, null: false
    t.text "text", null: false
    t.binary "visible", limit: 1, default: "b'1'", null: false
  end

  create_table "wp_cocoon_function_texts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci", force: :cascade do |t|
    t.datetime "date", null: false
    t.datetime "modified", null: false
    t.string "title", limit: 126, null: false
    t.text "text", null: false
  ...
  create_table "wp_cocoon_item_rankings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci", force: :cascade do |t|
    t.datetime "date", null: false
    t.datetime "modified", null: false
    t.string "title", limit: 126
    t.text "item_ranking", null: false
    t.bigint "count", default: 1
    t.binary "visible", limit: 1, default: "b'1'", null: false
  end

  create_table "wp_cocoon_speech_balloons", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci", force: :cascade do |t|
    t.datetime "date", null: false
    t.datetime "modified", null: false
    t.string "title", limit: 126
    t.string "name", limit: 36
    t.string "icon", limit: 256, default: "http://localhost:3000/wp-content/themes/cocoon-master/images/anony.png", null: false
    t.string "style", limit: 20, default: "stn", null: false
    t.string "position", limit: 20, default: "l", null: false
    t.string "iconstyle", limit: 20, default: "cb", null: false
    t.string "credit", limit: 256
    t.binary "visible", limit: 1, default: "b'1'", null: false
  end
